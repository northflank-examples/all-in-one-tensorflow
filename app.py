...
def initialize_model():
    ...
    if os.path.exists("/home/jovyan/shared/model.keras"):
        try:
            model = keras.models.load_model("/home/jovyan/shared/model.keras")
            print("Loaded existing model from /home/jovyan/shared/model.keras")
...
async def model_info():
    ...
    return {
        ...
        "model_file_exists": os.path.exists("/shared/model.keras"),
        "classes": classes,
